...
function ChatWindow({
  ...
  return (
    <Window className="window">
      ...
      <WindowContent className="window-content" style={{ display: "flex" }}>
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ height: "16px" }}>
            {isGenerating && <span>{assistantScreenName} is typing...</span>}
          </div>
          <div
            style={{
              display: "flex",
            ...
            <div style={{}}>
              ...
              >
                <Image
                  ...
                  style={{
                    filter:
                      !isReady || isGenerating ? "grayscale(100%)" : undefined,
                  }}
                  width="40"
                  height="40"
                />
