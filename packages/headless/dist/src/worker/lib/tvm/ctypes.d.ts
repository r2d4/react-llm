 ...
 */
export type FTVMModGetFunction = (mod: Pointer, funcName: Pointer, queryImports: number, out: Pointer) => number;
/**
 ...
 *                 int* ret_type_code);
 */
export type FTVMFuncCall = (func: Pointer, argValues: Pointer, typeCode: Pointer, nargs: number, retValue: Pointer, retCode: Pointer) => number;
/**
 ...
 *                       int num_ret);
 */
export type FTVMCFuncSetReturn = (ret: Pointer, value: Pointer, typeCode: Pointer, numRet: number) => number;
/**
 ...
 */
export type FTVMFuncRegisterGlobal = (name: Pointer, f: Pointer, override: number) => number;
/**
 ...
 *                   TVMArrayHandle* out);
 */
export type FTVMArrayAlloc = (shape: Pointer, ndim: number, dtypeCode: number, dtypeBits: number, dtypeLanes: number, deviceType: number, deviceId: number, out: Pointer) => number;
/**
 ...
 *                           size_t nbytes);
 */
export type FTVMArrayCopyFromBytes = (handle: Pointer, data: Pointer, nbytes: number) => number;
/**
 * int TVMArrayCopyToBytes(TVMArrayHandle handle,
 *                         void* data,
 *                         size_t nbytes);
 */
export type FTVMArrayCopyToBytes = (handle: Pointer, data: Pointer, nbytes: number) => number;
/**
 * int TVMArrayCopyFromTo(TVMArrayHandle from,
 *                        TVMArrayHandle to,
 *                        TVMStreamHandle stream);
 */
export type FTVMArrayCopyFromTo = (from: Pointer, to: Pointer, stream: Pointer) => number;
/**
 * int TVMSynchronize(int device_type, int device_id, TVMStreamHandle stream);
 */
export type FTVMSynchronize = (deviceType: number, deviceId: number, stream: Pointer) => number;
/**
 ...
 *                                      int* out_ret_tcode);
 */
export type FTVMBackendPackedCFunc = (argValues: Pointer, argCodes: Pointer, nargs: number, outValue: Pointer, outCode: Pointer) => number;
/**
 ...
 */
export type FTVMWasmPackedCFunc = (args: Pointer, typeCodes: Pointer, nargs: number, ret: Pointer, resourceHandle: Pointer) => number;
/**
 * int TVMWasmFuncCreateFromCFunc(void* resource_handle,
 *                                TVMFunctionHandle *out);
 */
export type FTVMWasmFuncCreateFromCFunc = (resource: Pointer, out: Pointer) => number;
/**
 ...
 */
export declare const enum ArgTypeCode {
    Int = 0,
    UInt = 1,
    Float = 2,
    TVMOpaqueHandle = 3,
