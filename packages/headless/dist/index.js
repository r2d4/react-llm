import { v as v4, _ as __spreadArray, a as __assign } from './v4-4ce9d9ab.js';
import require$$0, { useDebugValue, useState, useEffect, useRef } from 'react';
...
var defaultSystemPrompt = "A chat between a curious user and an artificial intelligence assistant. " +
    "The assistant gives helpful, detailed, and polite answers to the user's questions.";
var useConversationStore = create()(persist(function (set, get) { return ({
    conversations: [
        {
            id: v4(),
...
var useLLM = function (props) {
    var _a = useState({
        ...
        fetchedBytes: 0,
        totalBytes: 0,
    }), loadingStatus = _a[0], setLoadingStatus = _a[1];
    var _b = useState(100), maxTokens = _b[0], setMaxTokens = _b[1];
    ...
    useEffect(function () {
        ...
        if (!workerRef.current) {
            workerRef.current = new Worker(new URL("worker-05d86ed6.js", import.meta.url));
        }
        if (props === null || props === void 0 ? void 0 : props.autoInit) {
    ...
    useEffect(function () {
        ...
        workerRef.current.onmessage = function (event) {
            ...
            switch (event.data.type) {
                ...
                case "generateText":
                    var resp = event.data;
                    cStore === null || cStore === void 0 ? void 0 : cStore.addMessage(cStore === null || cStore === void 0 ? void 0 : cStore.conversationId, {
                        id: resp.requestId,
                        createdAt: new Date().getTime(),
    ...
    }, [cStore === null || cStore === void 0 ? void 0 : cStore.conversationId, workerRef]);
    useEffect(function () {
        if ((cStore === null || cStore === void 0 ? void 0 : cStore.conversationId) === "" && cStore.conversations.length > 0) {
            cStore.conversationId =
                cStore === null || cStore === void 0 ? void 0 : cStore.conversations[(cStore === null || cStore === void 0 ? void 0 : cStore.conversations.length) - 1].id;
        }
    }, [cStore === null || cStore === void 0 ? void 0 : cStore.conversationId, cStore === null || cStore === void 0 ? void 0 : cStore.conversations]);
    var sendUserMessage = function (text) {
        var _a;
        ...
        var conversation = cStore === null || cStore === void 0 ? void 0 : cStore.getConversation(cStore === null || cStore === void 0 ? void 0 : cStore.conversationId);
        if (!conversation) {
            conversation = {
                id: v4(),
                systemPrompt: defaultSystemPrompt,
            ...
            cStore === null || cStore === void 0 ? void 0 : cStore.createConversation(conversation);
        }
        else {
            cStore === null || cStore === void 0 ? void 0 : cStore.addMessage(conversation.id, {
                id: v4(),
                createdAt: new Date().getTime(),
                updatedAt: new Date().getTime(),
                role: "user",
        ...
        (_a = workerRef.current) === null || _a === void 0 ? void 0 : _a.postMessage({
            type: "generateText",
            conversation: __assign(__assign({}, conversation), { messages: __spreadArray(__spreadArray([], conversation.messages, true), [msg], false) }),
            maxTokens: maxTokens,
        });
    };
    return {
        conversationId: cStore === null || cStore === void 0 ? void 0 : cStore.conversationId,
        ...
        init: function () {
            var _a;
            return (_a = workerRef.current) === null || _a === void 0 ? void 0 : _a.postMessage({
                type: "init",
            });
        },
        setMaxTokens: setMaxTokens,
        allConversations: cStore === null || cStore === void 0 ? void 0 : cStore.conversations,
        conversation: cStore === null || cStore === void 0 ? void 0 : cStore.getConversation(cStore === null || cStore === void 0 ? void 0 : cStore.conversationId),
        createConversation: function (c) { return cStore === null || cStore === void 0 ? void 0 : cStore.createConversation(c); },
        deleteAllConversations: function () { return cStore === null || cStore === void 0 ? void 0 : cStore.deleteAllConversations(); },
        clearMessages: function () { return cStore === null || cStore === void 0 ? void 0 : cStore.deleteMessages(cStore === null || cStore === void 0 ? void 0 : cStore.conversationId); },
    };
};

export { useLLM as default };
