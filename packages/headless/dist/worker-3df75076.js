...
var LLMInstance = /** @class */ (function () {
    ...
    LLMInstance.prototype.generate = function (conversation, stopTexts, maxTokens, callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model.generate(conversation, stopTexts, maxTokens, callback)];
                    case 1:
                        _a.sent();
                        this.processing = false;
                        return [2 /*return*/];
...
var LLMInstanceScope = /** @class */ (function () {
    ...
    LLMInstanceScope.prototype.generate = function (conversation, stopTexts, maxTokens, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var tokens, _a, _b, _c, _d, _e, _f, inputTokenLength, outputText, tstart, tend, step, id, input, logits, nextToken, outputTokens, stopPos;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0: return [4 /*yield*/, this.getTokens(conversation, maxTokens)];
                    case 1:
                        tokens = _g.sent();
                        _b = (_a = tokens.push).apply;
                        _c = [tokens];
                        return [4 /*yield*/, this.tokenizer.encodeIds("assistant:")];
                    case 2:
                        _b.apply(_a, _c.concat([(_g.sent())]));
                        _e = (_d = console).log;
                        _f = ["Decoded: "];
    ...
    LLMInstanceScope.prototype.reset = function () {
        this.clearKVCache();
        this.kvCacheLength = 0;
        this.lastMessageId = "";
    };
...
var worker = {
    ...
    generate: function (conversation, stopTexts, maxTokens, callback) {
